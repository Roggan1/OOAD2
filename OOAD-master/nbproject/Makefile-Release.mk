...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ooad-master

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ooad-master: ${OBJECTFILES}
...
${OBJECTDIR}/Flug.o: Flug.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Flug.o Flug.cpp
